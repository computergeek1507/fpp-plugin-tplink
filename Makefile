...
OBJECTS_fpp_tplink_so += src/tplinkPlugin.o src/TPLinkItem.o src/TPLinkLight.o src/TPLinkSwitch.o src/BaseItem.o src/BaseSwitch.o src/GoveeLight.o src/TasmotaLight.o src/TasmotaSwitch.o
