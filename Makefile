...
OBJECTS_fpp_tplink_so += src/tplinkPlugin.o src/TPLinkItem.o src/TPLinkLight.o src/TPLinkSwitch.o src/BaseItem.o src/BaseSwitch.o src/BaseLight.o src/GoveeLight.o src/TasmotaLight.o src/TasmotaSwitch.o src/TapoItem.o src/TapoLight.o src/TapoSwitch.o src/core/KasaProtocol.o src/core/KasaSocket.o src/core/MiniJson.o src/core/RelaySender.o
